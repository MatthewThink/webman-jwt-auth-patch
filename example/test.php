...
$token = \bdhert\JwtAuth\facade\JwtAuth::token(1, ['id' => 1, 'time' => time()])->toString();


// var_dump(\bdhert\JwtAuth\facade\JwtAuth::verify($token));
// var_dump(\bdhert\JwtAuth\facade\JwtAuth::parseToken($token));
